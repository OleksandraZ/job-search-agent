...
def test_no_careers_page_found_anywhere_resolves_to_unresolved(monkeypatch):
    ...
    assert result == {"ats": None, "identifier": None, "careers_url": None, "match_method": None}
...
def test_career_link_pattern_matches_german_terms():
    ...
    assert resolve_ats._find_career_link("https://acme.test", html) == "https://acme.test/stellenangebote"
...
def test_one_company_failing_does_not_stop_the_others(monkeypatch):
    ...
    assert companies[0]["ats"] is None
